 ...
 * It deletes or moves the /src and /scripts directories to /example based on user input and creates a new /src/app directory with an LoginScreen.tsx and _layout.tsx file.
...
const moveDirectories = async (userInput) => {
  try {
    ...
    const indexPath = path.join(newAppDirPath, "LoginScreen.tsx");
    await fs.promises.writeFile(indexPath, indexContent);
    console.log("📄 src/app/LoginScreen.tsx created.");
