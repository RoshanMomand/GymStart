<?php
    ...
    class ProfileController extends Controller
    {
        ...
        public function updateWeight (Request $request): JsonResponse
        {
            ...
            $previous = WeightLog::where('user_id', $user->id)->where('id', '<', $log->id)->orderByDesc('logged_at')->first();
        ...
        {
            $logs = WeightLog::where('user_id', Auth::id())->orderByDesc('logged_at')->limit(90)->get()->map(fn ($log) => [
                'id'        => $log->id,
