<?php
    ...
    {
        public function __construct (private readonly MealPlanService $mealPlanService, private readonly WorkoutPlanService $workoutPlanService)
        {
        }
        ...
        public function store (OnboardingRequest $request): JsonResponse
        {
            try
            {
                ...
                // Generate meal plan and workout plan simultaneously
                $mealPlan = $this->mealPlanService->generateForUser($freshUser);
                $workoutPlan = $this->workoutPlanService->generateForUser($freshUser);
                ...
                return response()->json([
                    ...
                    'data'    => [
                        ...
                        'workout_plan' => [
                            'id'            => $workoutPlan->id,
                            'training_days' => count($workoutPlan->exercises ?? []),],],], 201);
