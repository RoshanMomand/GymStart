    ...
    class ExerciseDbService
    {
        ...
        public function getBodyParts (): array
        {
            try
            {
                $response = Http::withHeaders([
                    ...
                    'x-rapidapi-host' => $this->apiHost,])->get("{$this->baseUrl}/status");
        ...
        public function getExercisesByBodyPart (string $bodyPart, int $limit = 10): array
        {
            try
            {
                $response = Http::withHeaders([
                    'x-rapidapi-key'  => $this->apiKey,
                    'x-rapidapi-host' => $this->apiHost,])->get("{$this->baseUrl}/exercises/bodyPart/{$bodyPart}", [
                    'limit' => $limit,]);
        ...
        public function getExercisesByTarget (string $target, int $limit = 10): array
        {
            try
            {
                $response = Http::withHeaders([
                    'x-rapidapi-key'  => $this->apiKey,
                    'x-rapidapi-host' => $this->apiHost,])->get("{$this->baseUrl}/exercises/target/{$target}", [
                    'limit' => $limit,]);
        ...
        public function getExercisesByEquipment (string $equipment, int $limit = 10): array
        {
            try
            {
                $response = Http::withHeaders([
                    'x-rapidapi-key'  => $this->apiKey,
                    'x-rapidapi-host' => $this->apiHost,])->get("{$this->baseUrl}/exercises/equipment/{$equipment}", [
                    'limit' => $limit,]);
        ...
        public function getExerciseById (string $id): array
        {
            try
            {
                $response = Http::withHeaders([
                    'x-rapidapi-key'  => $this->apiKey,
                    'x-rapidapi-host' => $this->apiHost,])->get("{$this->baseUrl}/exercises/exercise/{$id}");
         ...
         */
        public function getExercisesByBodyPartAndEquipment (string $bodyPart, array $equipmentTypes, int $limit = 5): array
        {
            ...
            $filtered = collect($exercises)->filter(fn ($ex) => in_array($ex['equipment'] ?? '', $equipmentTypes))->take($limit)->values()->toArray();
